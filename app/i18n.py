...
MESSAGES: dict[str, dict[str, str]] = {
    "ja": {
        ...
        "login.password_submit": "メールアドレスでログイン",
        "login.or": "または",
        "login.google": "Googleアカウントでログイン",
        "login.error.placeholder": "ログインエラー表示領域",
        ...
        "login.error.password": "メールアドレスまたはパスワードが正しくありません。",
        "login.error.expired": "ログイン画面の有効期限が切れました。もう一度入力してください。",
        "login.error.rate_limit": "ログイン試行回数が上限に達しました。5分後にもう一度お試しください。",
        "sites.title": "サイト一覧",
        "sites.aria": "管理サイト",
        "sites.site": "サイト",
        "sites.status": "公開状態",
    ...
    "en": {
        ...
        "login.password_submit": "Sign in with email",
        "login.or": "or",
        "login.google": "Sign in with Google",
        "login.error.placeholder": "Login error message area",
        ...
        "login.error.password": "The email address or password is incorrect.",
        "login.error.expired": "The login page expired. Please enter your details again.",
        "login.error.rate_limit": "Too many sign-in attempts. Please try again in 5 minutes.",
        "sites.title": "Sites",
